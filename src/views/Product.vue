...
import HeaderAldian from "@/components/HeaderAldian.vue";
import FooterAldian from "@/components/FooterAldian.vue";
import carousel from 'vue-owl-carousel';
import RelatedAldian from "@/components/RelatedAldian.vue";
